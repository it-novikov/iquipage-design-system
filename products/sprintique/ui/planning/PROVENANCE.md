...
R4 audit additionally reconciles the targeted committed-timeline/readback recovery fix from upstream commit `983de1319266cd2c8ff3ff4a87260e3efc8e90e0`. The public roadmap is recreated only to discard an unsaved local preview; a committed command is never replayed for UI repair. Host disposal guards and coalesced invalidation remain product integration changes. Later PR3 work-list/windowing and UX redesign proposals are not imported by this repair.

...
def validate(data:dict, evidence_root:Path, current_fingerprint:str|None=None)->dict:
    ...
    blocks.append('Legacy schema 1.0 is diagnostic only; use independent plan and schema 2.0.')
    ...
    return {'schema_version':'1.0','structure_valid':not errors,'gate_ready':False,

...
| GitHub CI / Ubuntu 24.04, после security-исправлений |PASS: 215 DS, 142 product, 142 detached; runtime image build | [Run 35091658291](https://github.com/it-novikov/iquipage-design-system/actions/runs/35091658291), commit `474ee333a4c9977e321182cf3246d35db1d0f2c5`; скачанные артефакты (`2026-09-16T11-41-42.668Z`) содержат тот же fingerprint и DS hash |
...
Владелец согласовал изменения поведения из [SECURITY.md](SECURITY.md) и слияние PR #4 при зафиксированном неполном покрытии глубокой security-проверки. Перед слиянием на обновлённой ветке повторены: Docker PostgreSQL gate с настоящим private S3 — 142/142 без пропусков; сборка runtime-образа `sha256:e7f26d6588d087a8eef745226ca1a98f5e9666ae0bc4a4f0ec27d99c122b8c17` и его запуск non-root/read-only с readiness на настоящих QA PostgreSQL/S3. Проверка сессии в контейнере не выполнена: сохранённая QA-сессия OIDC от 12 сентября истекла. Полный повторный deep scan и production deployment — отдельные шаги; цель развёртывания, секреты и план данных не заданы.

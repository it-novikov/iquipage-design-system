...
export async function seed(repository){
  ...
  for(const r of releases)await repository.write('releases',{...r,projectId:project.id,status:'planned',planningFormat:'flexible',revision:0},0);

...
const allowed=['packages/work-list/dist/','packages/work-list/src/work-list.css','packages/work-list/src/compact-work.css','packages/planning/src/','packages/planning/demo/','packages/maps/src/','packages/maps/dist/vendor/'];

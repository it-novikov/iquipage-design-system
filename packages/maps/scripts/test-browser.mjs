...
try{
  ...
  for(const suite of ['tests/browser-r3.mjs','tests/browser-host-contract.mjs','tests/browser-events-final.mjs','tests/browser-delivery-recovery.mjs','tests/browser-board-b1.mjs','tests/browser-board-interactions.mjs','tests/browser-board-motion.mjs','tests/browser-board-b2.mjs','tests/browser-board-b2-recovery.mjs','tests/browser-attachment-idb.mjs','tests/browser-covers.mjs','tests/browser-thread-pages.mjs','tests/browser-editor-move.mjs','tests/browser-map-task-link.mjs','tests/browser-cover-finish.mjs'])await new Promise((resolve,reject)=>{

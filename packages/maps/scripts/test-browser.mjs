...
try{
  ...
  for(const suite of ['tests/browser-r3.mjs','tests/browser-events-final.mjs','tests/browser-delivery-recovery.mjs','tests/browser-board-b1.mjs','tests/browser-board-interactions.mjs','tests/browser-board-motion.mjs'])await new Promise((resolve,reject)=>{

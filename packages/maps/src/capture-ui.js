...
export async function captureDialog(feature) {
  ...
  const draft=feature.captureDrafts?.get(mapId)||{type:'sticky',area:'',entries:[cardEntry(),cardEntry()]};

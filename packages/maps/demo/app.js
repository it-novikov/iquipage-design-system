...
let feature=null,taskBoard=null,section=standalone?'maps':'tasks',navigationGeneration=0;
const boardState={};
const canLeave=async()=>!taskBoard?.readyToLeave||await taskBoard.readyToLeave();
...
async function startWorkspace(){
  ...
  async function navigate(next){
    ...
    section=['tasks','maps','settings','settings/automation'].includes(next)?next:(standalone?'maps':'tasks');
